                    ...
                    <div className="space-y-8">
                        ...
                        <div className="pt-8">
                            ...
                            <div className="flex space-x-4 justify-center">
                                <a href="https://www.linkedin.com/in/jason-strife-1b6843208" target="_blank">
                                    <Linkedin />
                                </a>
                                <a href="https://app.joinhandshake.com/profiles/ymmzt2" target="_blank">
                                    <Handshake />
                                </a>
                            </div>
                        </div>
